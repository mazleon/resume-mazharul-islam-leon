...
\begin{rSubsection}{CMED Health Ltd., Bangladesh}{Sep 2020 - July 2021}{Jr. Data Science Engineer}{Full-time}
 \item Designed and implemented data extraction pipelines from SQL dump files.
 \item Performed data cleaning and preprocessing to prepare datasets for analysis.
 \item Applied advanced data analysis techniques to derive actionable insights.
 \item Collaborated with stakeholders and cross-functional teams to share data-driven insights.
 \item Actively participated in writing research papers based on the processed datasets.
 \end{rSubsection}
