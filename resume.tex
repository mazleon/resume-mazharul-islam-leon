...
\address{Dhaka, Bangladesh $\diamond$ (+880) 1911687821 $\diamond$ mzleon.cse@gmail.com $\diamond$ \href{https://mazleon.com}{mazleon.com}}
...
Senior AI Engineer (5+ years) specializing in scalable Computer Vision and Generative AI systems. Delivered solutions for 30M+ users, optimizing real-time inference (<50ms) and deploying LLM agents handling 10K+ daily queries. Expert in end-to-end ML system design, MLOps, and edge AI deployment.
\end{rSection}
...
{\small
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{4ex}} p{0.65\textwidth} }
...
\begin{rSubsection}{CMED Health Ltd., Bangladesh}{Sep 2020 - July 2021}{Junior Data Science Engineer}{Full-time}
 ...
 \item Performed data preprocessing, and exploratory analysis to support research \& business insights.
